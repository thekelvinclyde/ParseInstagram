...
There were no challenges to building this app, honestly. However, though I have no erros, the application is still not displaying a profile on the profile fragment. It also crashed whenever I tried to submit a post on the compose fragment. 
